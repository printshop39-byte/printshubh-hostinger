...
const copy = {
  mr: {
    ...
    headlineStart: "फाइल पाठवा.",
    headlineAccent: "काम तयार मिळवा.",
    support:
      "प्रिंटिंग, फोटो आणि जमीन कागदपत्रांसाठी एकच विश्वासार्ह ठिकाण. किंमत व उपलब्धता आधी कळवूनच काम सुरू.",
    panelKicker: "आज कोणते काम आहे?",
    panelTitle: "सेवा निवडा आणि थेट पुढे जा",
